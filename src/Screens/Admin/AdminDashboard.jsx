      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="flex items-center gap-4 p-5 rounded-xl backdrop-blur-xl bg-black/20 border border-white/20 text-white">
            <div className="p-3 rounded-lg bg-white/20">
              <FiTag size={24} className="text-green-600"/>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 p-5 rounded-xl  backdrop-blur-xl bg-black/20 border border-white/20 text-white">
            <div className="p-3 rounded-lg bg-white/20">
              <FiBox size={24} className="text-blue-700"/>
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 p-5 rounded-xl  backdrop-blur-xl bg-black/20 border border-white/20 text-white">
            <div className="p-3 rounded-lg bg-white/20">
              <FiMessageSquare size={24} className="text-purple-700" />
            </div>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-10">
          ...
          <div className="flex gap-2 mb-4">
            ...
            <div className="grid grid-cols-3 bg-gray-600 rounded-lg p-4 text-sm text-gray-300 pb-3 border-b border-white/20">
              <p>Product Name</p>
              <p>Category</p>
              <p>Rating</p>
            </div>
            <div className="grid grid-cols-3  p-4 text-sm border-b border-white/10">
